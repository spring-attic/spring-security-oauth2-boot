...
import org.springframework.boot.autoconfigure.security.oauth2.authserver.jwt.OAuth2JwtKeyStoreConfiguration;
...
@Import({ OAuth2AuthorizationServerConfiguration.class, OAuth2JwtKeyStoreConfiguration.class,
